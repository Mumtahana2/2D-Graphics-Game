...
catcher = DiamondGame(200, 0, 100, 20, 30)
diamond = DiamondGame(random.randint(0, WINDOW_WIDTH-30), WINDOW_HEIGHT-90, 30, 50, 1.0)  # Initial speed set to 1.0
collision = True
play = True
score = 0
game_over = False
...
def check_collision():
   ...
   if catcher.collides_with(diamond):
       score += 1
       speed = diamond.speed
       diamond = DiamondGame(random.randint(0, WINDOW_WIDTH-30), WINDOW_HEIGHT-90, 30, 50, diamond.speed)
...
def mouse_click(button, state, x, y):
    ...
    if button == GLUT_LEFT_BUTTON and state == GLUT_UP:
        if mx >= 0 and mx <= 60 and my >= 680 and my <= 740:
            score = 0
            catcher = DiamondGame(200, 0, 100, 20, 20)
            diamond = DiamondGame(random.randint(0, WINDOW_WIDTH-30), WINDOW_HEIGHT-90, 30, 50, diamond.speed)  # Use current speed
            play = True
            collision = True
            print("Starting over!")
            game_over = False
...
wind = glutCreateWindow(b"OpenGL DiamondGame Collision")
